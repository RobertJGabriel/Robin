ljs.load(['http://ajax.googleapis.com/ajax/libs/angularjs/1.3.14/angular.min.js', 'assets/js/lib/jquery-1.11.3.js', 'http://www.cornify.com/js/cornify.js'], 'assets/js/lib/core.js',
