...
app.controller('controller', function ($scope) {
    ...
    function parser(url) {
        ...
        async.waterfall([
           ...
           //  console.log("Should we block it ? " + classifier.categorize(words));
             console.log(classifier.categorize("fuck her ass hard"));
...
console.log($scope.listOfProfanityWords);
console.log($scope.listOfGoodWords);
        ...
        ref.child("profanity").on('child_added', function (snapshot, prevChildKey) {
           ...
           for (var q in snapshot.val()) {    
            ...
            if (snapshot.val()["type"] === "good") {
                         ...
                         classifier.learn($scope.listOfGoodWords.toString(), 'positive');
